...
와플스튜디오 23.5기 7조 Server 저장소입니다.

---

## 📖 프로젝트 소개

SNU-TOTO는 서울대학교 학생들이 다양한 이벤트에 가상 포인트로 베팅하고, 친구들과 함께 예측의 재미를 즐길 수 있는 서비스입니다.
...
| **양해울** | Backend | 백엔드 개발 |
| **한영웅** | Backend | 백엔드 개발 |
| **장정윤** | Frontend | 프론트엔드 개발 |
| **정민건** | Frontend | 프론트엔드 개발 |
...
### 🎮 재미있는 서비스
- 친구들과 함께 다양한 이벤트에 베팅하며 즐길 수 있는 재미있는 서비스를 구현했습니다!
...
### 🏗️ 확장 가능한 설계
- 기존 2지선다 방식의 한계를 극복하여 **N개의 선택지**를 지원하는 유연한 이벤트 구조를 설계했습니다.
- "무승부" 옵션이나 객관식 퀴즈 형태의 이벤트도 지원 가능합니다.
...
### 3️⃣ 이벤트 생성
- 직접 베팅 이벤트를 만들어 친구들과 공유할 수 있습니다.
