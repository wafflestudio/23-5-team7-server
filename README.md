...
| 기능 | 설명 |
|------|------|
| **회원 인증** | SNU 메일 인증, Google OAuth 소셜 로그인 지원 |
| **이벤트 관리** | 다양한 베팅 이벤트 생성 및 관리 (N개 선택지 지원) |
| **실시간 베팅** | WebSocket을 통한 실시간 배당률 변동 확인 |
| **포인트 시스템** | 가상 포인트 베팅 및 정산 |
| **랭킹 시스템** | 포인트 기반 사용자 랭킹 |
| **커뮤니티** | 이벤트별 댓글 및 좋아요 기능 |
| **관리자 기능** | 유저 관리, 이벤트 정산, 계정 정지 등 |
...
### 🎮 재미있는 서비스
- 친구들과 함께 다양한 학교 이벤트에 베팅하며 즐길 수 있는 재미있는 서비스를 구현했습니다!
...
### 배당률이란?
배당률은 베팅 성공 시 받게 되는 포인트의 배수입니다. 배당률이 **3.0배**인 옵션에 1,000포인트를 베팅하고 적중하면 **3,000포인트**를 획득합니다.
